...
@section('content')
    <div class="main-container">
        <h1>Update {{ ucfirst($user->user_type) }}</h1>
        <form action="{{ route('update-users') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-input-group">
                ...
                <div>
                    <input type="text" name="uid" id="uid" value="{{ old('uid', $user->uid) }}">
                    @error('uid')
                        <span>{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-input-group">
                ...
                <div>
                    <input type="text" name="fcm_token" id="fcm_token" value="{{ old('fcm_token', $user->fcm_token) }}">
                    @error('fcm_token')
                        <span>{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-input-group">
                ...
                <div style="display: contents;">
                    @if ($user->image)
                        <img src="{{ $user->image }}" alt="{{ $user->name }}" width="300" height="150"
                            style="color: #8D8D8D">
                    @endif
            ...
            <div class="form-input-group">
                ...
                <div>
                    <input type="text" name="year_of_establishment" id="year_of_establishment"
                        value="{{ old('year_of_establishment', $user->year_of_establishment) }}">
            ...
            <div class="form-input-group">
                ...
                <div>
                    <input type="text" name="pincode" id="pincode" value="{{ old('pincode', $user->pincode) }}">
                    @error('pincode')
                        <span>{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-input-group">
                ...
                <div>
                    <input type="text" name="type_of_business" id="type_of_business"
                        value="{{ old('type_of_business', $user->type_of_business) }}">
            ...
            <div class="form-input-group">
                ...
                <div>
                    <input type="text" name="name_of_partner_1" id="name_of_partner_1"
                        value="{{ old('name_of_partner_1', $user->name_of_partner_1) }}">
            ...
            <div class="form-input-group">
                ...
                <div>
                    <input type="text" name="name_of_partner_2" id="name_of_partner_2"
                        value="{{ old('name_of_partner_2', $user->name_of_partner_2) }}">
            ...
            <div class="form-input-group">
                ...
                <div>
                    <input type="text" name="phoneno_2" id="phoneno_2"
                        value="{{ old('phoneno_2', $user->phoneno_2) }}">
                    @error('phoneno_2')
                        <span>{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-input-group">
                ...
                <div style="display: contents;">
                    @if ($user->vendor_live_photo)
                        <img src="{{ $user->vendor_live_photo }}" alt="Vendor Live Photo" width="300" height="150"
                            style="color: #8D8D8D">
                    @endif
            ...
            <div class="form-input-group">
                ...
                <div style="display: contents;">
                    @if ($user->business_live_photo)
                        <img src="{{ $user->business_live_photo }}" alt="Vendor Live Photo" width="300" height="150"
                            style="color: #8D8D8D">
                    @endif
            ...
            <div class="form-input-group">
                ...
                <div>
                    ...
                    <span id='gst_certificate_name'>{{ basename($user->partnersheep_deed) ?? 'No file chosen' }}</span>
            ...
            <div class="form-input-group">
                ...
                <div>
                    ...
                    <span id='partnersheep_deed_name'>{{ basename($user->partnersheep_deed) ?? 'No file chosen' }}</span>
            ...
            <div class="form-input-group">
                ...
                <div>
                    ...
                    <span id='adharcard_one_name'>{{ basename($user->partnersheep_deed) ?? 'No file chosen' }}</span>
            ...
            <div class="form-input-group">
                ...
                <div>
                    ...
                    <span id='adharcard_two_name'>{{ basename($user->partnersheep_deed) ?? 'No file chosen' }}</span>
            ...
            <div class="form-input-group">
                ...
                <div>
                    ...
                    <span id='cancel_cheque_name'>{{ basename($user->partnersheep_deed) ?? 'No file chosen' }}</span>
            ...
            <button type="button" class="button" id="cancel"
                onclick="window.location='{{ route('manage-users', ['type' => $user->user_type]) }}'">Cancel</button>
        </form>
    </div>
    <script>
