...
@section('content')
    <div class="main-container">
        ...
        <form class="car-form" action="{{ route('update-kilometers') }}" method="POST">
            @csrf
            @method('POST')
            ...
            <div>
                ...
                <input type="number" id="start_km" name="start_km" value="{{ old('start_km', $carKilometer->start_km) }}"
                    required>
                @error('start_km')
            ...
            <div>
                ...
                <input type="number" id="end_km" name="end_km" value="{{ old('end_km', $carKilometer->end_km) }}"
                    required>
                @error('end_km')
                    <div class="error-text">{{ $message }}</div>
                @enderror
